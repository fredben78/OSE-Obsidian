...
layout: OSE
name: Ours-garou
subtype: "Très intelligent, même sous sa forme d’ours. Il vit seul ou parmi les ours normaux."
image: 
ac: 2 (17), 8 (11) sous forme humaine
hit_dice: 6D8
thaco: 14(+5)
speed: 36m (12m)
...
traits:
  ...
  - name: Appel d’animaux
    desc: "Peut convoquer 1 ou 2 animaux de son espèce présents dans les alentours ([[Ours brun]]) . Ils arrivent en 2 (1d4) rounds."
  - name: Herbe au loup
  ...
  - name: Aimable
    desc: "Peut être amical, si on l’aborde de manière pacifique."
  - name: Étreinte d’ours
    desc: "Si une victime est touchée par les deux pattes au cours du même round, l’ours-garou l’étreint et lui inflige 9 (2d8) dégâts automatiques supplémentaires."
actions:
  - name: 2x Griffes 

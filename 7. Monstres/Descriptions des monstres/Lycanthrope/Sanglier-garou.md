...
layout: OSE
name: Sanglier-garou
subtype: "Semi-intelligent et irascible, on le confond souvent sous sa forme humaine avec un berserker."
image:
ac: 4 (15) (9 (10) sous forme humaine)
hit_dice: 4D8+1
thaco: 15(+4)
speed: 45m (15m)
...
traits:
  ...
  - name: Appel d’animaux
    desc: "Peut convoquer 1 ou 2 animaux de son espèce présents dans les alentours [[Sanglier]] . Ils arrivent en 2 (1d4) rounds."
  - name: Herbe au loup
  ...
  - name: Rage de bataille
    desc: "Sous forme humaine, peut entrer dans une rage folle : bonus de +2 pour toucher, combat à mort. La rage le pousse parfois à attaquer ses alliés."
actions:
  - name: 1x Défense/Morsure

...
layout: OSE
name: Rat-garou
subtype: "Rat humanoïde intelligent capable de se transformer en humain."
image:
ac: "7(12) (9(10) sous forme humaine)"
hit_dice: 3D8
thaco: 17(+2)
speed: 36m (12m)
...
traits:
  ...
  - name: Appel d’animaux
    desc: "Peut convoquer 1 ou 2 animaux de son espèce présents dans les alentours [[Rat normal|Rat]]. Ils arrivent en 2 (1d4) rounds."
  - name: Herbe au loup
  ...
  - name: Surprise
    desc: "Sur un 1-à-4 ; tendent des embuscades."
  - name: Langues
    desc: "Parle le commun, quelle que soit sa forme."
  - name: Armes
    desc: "Peut manier des armes également sous sa forme animale."
actions:
  - name: 1x Morsure

...
layout: OSE
name: Tigre-garou
subtype: "Montre un comportement félin : curieux, mais dangereux quand il est acculé. Ce sont des nageurs et des chasseurs talentueux."
image:
...
traits:
  ...
  - name: Appel d’animaux
    desc: "Peut convoquer 1 ou 2 animaux de son espèce présents dans les alentours (les rats-garous appellent des rats géants — voir p. XX). Ils arrivent en 2 (1d4) rounds."
  - name: Herbe au loup
  ...
  - name: Surprise
    desc: "Sur un 1-à-4, en raison de leur discrétion."
actions:
  - name: 2x Griffes
